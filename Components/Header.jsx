  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
        ...
        <div className='text-center my-8'>
          ...
          <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Hey Buddy Welcome To My Blogger Website Promote your blog posts 
            on social media and translate your content into multiple languages to reach a wider audience. 
            </p>
